...
addButton.addEventListener("click", () => {
  ...
  newInput1.setAttribute("placeholder", "學期");
  newInput1.classList.add("class-semester");

  let newInput2 = document.createElement("input");
  newInput2.setAttribute("type", "text");
  newInput2.setAttribute("placeholder", "科目名稱");
  newInput2.classList.add("class-title");

  let newInput3 = document.createElement("input");
  newInput3.setAttribute("type", "number");
  newInput3.setAttribute("placeholder", "學分數");
  newInput3.setAttribute("min", "0");
  newInput3.setAttribute("max", "5");
  ...
  newSelect.classList.add("select-grade");

  var opt1 = document.createElement("option");
  opt1.setAttribute("value", "");
  opt1.setAttribute("disabled", "");
  opt1.setAttribute("selected", "");
  let textNode1 = document.createTextNode("成績");
  opt1.appendChild(textNode1);

  var opt2 = document.createElement("option");
  opt2.setAttribute("value", "A+");
  let textNode2 = document.createTextNode("A+ (90-100)");
  opt2.appendChild(textNode2);

  var opt3 = document.createElement("option");
  opt3.setAttribute("value", "A");
  let textNode3 = document.createTextNode("A (85-89)");
  opt3.appendChild(textNode3);

  var opt4 = document.createElement("option");
  opt4.setAttribute("value", "A-");
  let textNode4 = document.createTextNode("A- (80-84)");
  opt4.appendChild(textNode4);

  var opt5 = document.createElement("option");
  opt5.setAttribute("value", "B+");
  let textNode5 = document.createTextNode("B+ (77-79)");
  opt5.appendChild(textNode5);

  var opt6 = document.createElement("option");
  opt6.setAttribute("value", "B");
  let textNode6 = document.createTextNode("B (73-76)");
  opt6.appendChild(textNode6);

  var opt7 = document.createElement("option");
  opt7.setAttribute("value", "B-");
  let textNode7 = document.createTextNode("B- (70-72)");
  opt7.appendChild(textNode7);

  var opt8 = document.createElement("option");
  opt8.setAttribute("value", "C+");
  let textNode8 = document.createTextNode("C+ (67-69)");
  opt8.appendChild(textNode8);

  var opt9 = document.createElement("option");
  opt9.setAttribute("value", "C");
  let textNode9 = document.createTextNode("C (63-66)");
  opt9.appendChild(textNode9);

  var opt10 = document.createElement("option");
  opt10.setAttribute("value", "C-");
  let textNode10 = document.createTextNode("C- (60-62)");
  opt10.appendChild(textNode10);

  var opt11 = document.createElement("option");
  opt11.setAttribute("value", "D");
  let textNode11 = document.createTextNode("D (50-59)");
  opt11.appendChild(textNode11);

  var opt12 = document.createElement("option");
  opt12.setAttribute("value", "E");
  let textNode12 = document.createTextNode("E (0-49)");
...
function handleSorting(direction) {
  ...
  for (let i = 0; i < graders.length; i++) {
    let class_semester = graders[i].children[0].value;
    let class_title = graders[i].children[1].value;
    let class_credit = graders[i].children[2].value;
    let select_grade = graders[i].children[3].value;
  ...
  for (let i = 0; i < objectArray.length; i++) {
    objectArray[i].select_grade_number = convertor(objectArray[i].select_grade);
  }

  // console.log(direction);
  // console.log(objectArray);
  // 進行排序
  objectArray = mergeSort(objectArray, direction);
  // console.log(objectArray);
  ...
  for (let i = 0; i < objectArray.length; i++) {
    ...
    <div class="grader">
        ...
        value=${objectArray[i].class_semester}
        /><!--
        --><input
        type="text"
        placeholder="科目名稱"
        class="class-title"
        value=${objectArray[i].class_title}
        /><!--
        --><input
        type="number"
        placeholder="學分數"
        ...
        <option value="" disabled selected>成績</option>
  ...
  for (let i = 0; i < graders.length; i++) {
    graders[i].children[3].value = objectArray[i].select_grade;
  }

  // select事件監聽
  allSelects = document.querySelectorAll(".select-grade");
  allSelects.forEach((select) => {
    changeColor(select);
    select.addEventListener("change", (e) => {
      setGPA();
  ...
  while (i < a1.length && j < a2.length) {
    if (
      (direction === "descending" &&
        a1[i].select_grade_number < a2[j].select_grade_number) ||
      (direction === "ascending" &&
        a1[i].select_grade_number > a2[j].select_grade_number)
    ) {
      result.push(a2[j]);
